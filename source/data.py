...
class Dicts(object):
    def __init__(self, dict_path):
        ...
        self.Dict1, self.Dict2=pkl.load(f, encoding='bytes')
        self.Dict1 = {k.decode("utf-8") : v for k, v in self.Dict1.items()}
        self.Dict2 = {k : v.decode("utf-8") for k, v in self.Dict2.items()}
        # -----------------------
        f.close()
